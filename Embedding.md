...
*该功只是辅助，无法替代总结，不会自动压缩上下文。总结需使用预设手动总结*
*现在可以手动固定记忆，固定的记忆每次都会发送，避免重要记忆没有被召回。*
*要实现更细节的记忆，可以使用世界书和宏变量，要求AI将细节记录到聊天变量中，然后在世界书中使用宏读取变量内容发送给AI。*
...
配合一些预设的总结功能，以及隐藏楼层功能和全局正则，可以实现超长上下文的聊天，
